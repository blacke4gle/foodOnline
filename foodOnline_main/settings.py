...
ALLOWED_HOSTS = ['139.162.172.155', '127.0.0.1',
                 'sadullahfoodonline.com.tr', 'www.sadullahfoodonline.com.tr']
...
MIDDLEWARE = [
    ...
    # custom middleware created to access the request object in models.pt
]
